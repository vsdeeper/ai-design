...
Web 出图提示词模板见 [PROMPTS.md](./PROMPTS.md)；工程与编码约定见 [AGENTS.md](./AGENTS.md)。
...
需要落地页、营销站、产品页等 **section 级视觉参考图**，供设计评审或后续写代码对照。
...
精简版与完整示例见 [PROMPTS.md](./PROMPTS.md)。
...
```text
请按 image-to-code 技能实现本仓库的落地页首页。

产品：[名称]
目标：营销落地页，约 [N] 个 section
风格：[关键词]，气质：[说明]
...
动效：克制流体
主色方向：[一句话]
禁忌：不要 AI 紫霓虹、不要 Inter、不要三等分卡片堆砌
...
A: 本文档说明 **何时用、怎么用**；[PROMPTS.md](./PROMPTS.md) 提供可复制的 **提示词模板**（目前以 web 出图为主）。
